...
import { Formik, Form } from 'formik';
import { TextInputBox } from '../components/forms'; // Ensure this component exists
...
export default function LoginOtp() {
  ...
  const initVal: otpNum = { mobile: '09194813585', otpNumber:'123' };

  const handleNavigation = (value:otpNum) => {
    console.log(value)
  //  router.push(Routes.posts.POSTS); // Navigate to the About page
 };
