    ...
    <div className=" items-center justify-center ">
       {posts?.map((item,i)=> (
        <div key={item.id} className="bg-gray-200 p-6 rounded shadow-xl w-full max-w-5xl mx-auto my-4">
          ...
          <Link type="button" className="border rounded-md border-amber-700 px-3 py-1 " href={Routes.posts.POSTS+`/${item.id}`}><div className="hover:text-purple-800 hover:bg-red-950">
           continue...
            </Link>
</div>
          </div>
