...
<div className="hover:text-purple-800 hover:bg-red-950">

          <Link type="button" className="border rounded-md border-amber-700 px-3 py-1 " href={Routes.posts.POSTS+`/${item.id}`}> continue... </Link>
</div>
          </div>
       ))}
